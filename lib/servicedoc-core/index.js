...
var app = {
    ...
    filters: {
        serviceparam                 : './filters/service_param.js',
        servicesuccess               : './filters/service_success.js'
    },
    languages: {
    ...
    parsers: {
        servicedefine                : './parsers/service_define.js',
        serviceexample               : './parsers/service_example.js',
        serviceiuse                  : './parsers/service_use.js',
        servicedeprecated            : './parsers/service_deprecated.js',

        service                  : './parsers/service.js',
        serviceauthor            : './parsers/service_author.js',
        serviceversion           : './parsers/service_version.js',
        servicedescription       : './parsers/service_description.js',
        servicegroup             : './parsers/service_group.js',
        servicename              : './parsers/service_name.js',
        servicefunction          : './parsers/service_description.js',
        serviceparam             : './parsers/service_param.js',
        serviceparamexample      : './parsers/service_param_example.js',
        serviceresult            : './parsers/service_result.js',
        serviceresultexample     : './parsers/service_result_example.js'

    },
    workers: {
        servicegroup                 : './workers/service_group.js',
        servicename                  : './workers/service_name.js',
        serviceparamtitle            : './workers/service_param_title.js',
        servicepermission            : './workers/service_permission.js',
        servicestructure             : './workers/service_structure.js',
        serviceresulttructure        : './workers/service_result_structure.js',
        serviceresulttitle           : './workers/service_result_title.js',
        serviceuse                   : './workers/service_use.js'
    },
    hooks: {},
    addHook: addHook,
    hook: applyHook
...
var defaultGenerator = {
    name   : 'servicedoc',
    time   : new Date(),
    url    : 'http://servicedocjs.com',
    version: '0.0.0'
};

// TODO: find abetter name for PackageInfos (-> servicedoc-conf)
...
function parse(options) {
    ...
    try {
        ...
        app.log.verbose('servicedoc-generator name: '    + app.generator.name);
        app.log.verbose('servicedoc-generator version: ' + app.generator.version);
        app.log.verbose('servicedoc-core version: '      + packageJson.version);
        app.log.verbose('servicedoc-spec version: '      + getSpecificationVersion());
        ...
        if (parsedFiles.length > 0) {
            ...
            // add serviceDoc specification version
            app.packageInfos.servicedoc = SPECIFICATION_VERSION;
 ...
 * Set package infos.
 *
 * @param {Object} [packageInfos]             Collected from servicedoc.json / package.json.
 ...
 * @param {String} [packageInfos.sampleUrl]   @see http://servicedocjs.com/#param-api-sample-request
 */
 ...
 *
 * @param {String}   name           Name of the hook. Hook overview: https://github.com/servicedoc/servicedoc-core/hooks.md
